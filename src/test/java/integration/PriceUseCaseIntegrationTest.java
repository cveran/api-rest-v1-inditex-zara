...
class PriceUseCaseIntegrationTest {
    ...
    @CsvSource({
            "'2020-06-14T10:00:00', 35455, 1, 35.50, 1",
            "'2020-06-14T16:00:00', 35455, 1, 25.45, 2",
            "'2020-06-14T21:00:00', 35455, 1, 35.50, 1",
            "'2020-06-15T10:00:00', 35455, 1, 30.50, 3",
            "'2020-06-16T21:00:00', 35455, 1, 38.95, 4"
    })

    @DisplayName("Debería devolver el precio esperado para fecha y producto dados")
    void shouldReturnExpectedPrice(String applicationDate, Long productId, Long brandId, double expectedPrice, int expectedList) {
        ...
        assertThat(response.getBody().getPriceList()).isEqualTo(expectedList);
        assertThat(response.getBody().getPrice()).isEqualByComparingTo(String.valueOf(expectedPrice));
